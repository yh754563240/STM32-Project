/*
 * @Author: Liuxo
 * @Date: 2021-01-08 18:15:11
 * @LastEditors: Liuxo
 * @LastEditTime: 2021-01-11 09:29:05
 * @Description: None
 */
...
#define PWM_PA8_ENABLE          (1)         // TIM1_CH1
...
#define TIM1_FREQUENCY          (1000)  // set pwm frequency for tim1
...
#define TIM3_FREQUENCY          (500)  // set pwm frequency for tim3
#define TIM3_DUTY               (50)    // set pwm duty-cycle for tim3
#else
